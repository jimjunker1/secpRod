...
The IGR method adds flexbility, but also potential complexity. For this method, it is expected that you provide a growth rate, *g* ($d^{-1}$). This can be accomplished in multiple ways:
