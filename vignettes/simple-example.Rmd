...
- growthForm: a character string that is coercible to a formula. This formula is parsed and will reference existing information (e.g., size information) if variables are included in the formula.
...
debug(is_prod.sample)
debugonce(calc_production)
debugonce(prep_boots)
set.seed(1312)
calc_production(
