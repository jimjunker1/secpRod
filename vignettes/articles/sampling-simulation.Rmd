...
# Model-averaged fit
p1 = plot_cohort_fit(remappedCohort, model = "ensemble")

# Specific model fit
p2 = plot_cohort_fit(remappedCohort, model = "vbg")
p3 = plot_cohort_fit(remappedCohort, model = "gompertz", label_points = FALSE)
p4 = plot_cohort_fit(remappedCohort, model = "logistic")

gridExtra::grid.arrange(list(p1,p2,p3,p4), ncol = 2, nrow = 2)
