...
The estimation of growth rates with this approach is only aplicable within a cohort--it will not make sense to apply to data from different cohorts. Identifying cohort structure from macroinvertebrate data is *currently* more of an art than a science and will depend on a number of things:
...
process_and_estimate_growth <- function(data, start_year, end_year, start_day_year1, end_day_year1, start_day_year2, end_day_year2) {
  ...
  # will depend on the specifics of the model and is beyond the scope of this optimization.
